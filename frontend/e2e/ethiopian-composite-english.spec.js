...
const sources = {
  genesis: {
    ...
    attribution: 'Official World Messianic Bible August 2022 stable text from eBible.org, dedicated to the public domain; its naming condition applies.',
    fallback: false,
    modified: true,
  ...
  baruch: {
    ...
    published_year: 1611,
    license: 'LicenseRef-Public-Domain',
    attribution: 'Public-domain KJV fallback reviewed against the locked 1611 witness; this is not a distinct Ethiopian Orthodox English translation.',
    fallback: true,
    modified: false,
    verification: { status: 'verified_rebuilt', verified_at: '2026-08-30T01:18:59Z' },
    canon_scope: 'ethio81',
  },
  meqabyan: {
    ...
    verification: { status: 'in_progress', verified_at: null },
    canon_scope: 'ethio81',
  },
  prayer: {
    source_key: 'kjv-1611-fallback',
