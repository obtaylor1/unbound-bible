...
NOTICE = """This direct English scripture ingester is retired and performs no data operation.

The reviewed English manifests and installed adapters are unavailable. Run from the backend directory:
