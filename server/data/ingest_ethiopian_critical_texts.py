...
NOTICE = """This direct Ethiopian critical-text ingester is retired and performs no data operation.

The reviewed Ethiopian manifests and installed adapters are unavailable. Run from the backend directory:
