...
NOTICE = """This direct original-language ingester is retired and performs no data operation.

The reviewed original-language manifests and installed adapters are unavailable.
