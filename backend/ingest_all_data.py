...
NOTICE = """This master direct ingestion launcher is retired and performs no data operation.

It does not run legacy ingestion scripts. Use only reviewed manifests and installed adapters.
