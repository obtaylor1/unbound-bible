...
NOTICE = """This direct Adam and Eve ingester is retired and performs no data operation.

The reviewed Adam and Eve manifest and installed adapter are unavailable.
