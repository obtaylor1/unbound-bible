...
NOTICE = """This direct KJV ingester is retired and performs no data operation.

The reviewed KJV manifest and installed adapter are unavailable. Run from the backend directory:
