...
NOTICE = """This sample scripture writer is retired and performs no data operation.

Sample or placeholder scripture must not be published. A reviewed manifest and installed adapter
are unavailable. Run from the backend directory:
